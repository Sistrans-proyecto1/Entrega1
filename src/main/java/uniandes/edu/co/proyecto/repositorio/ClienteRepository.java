...
public interface ClienteRepository extends JpaRepository<Cliente, Integer> {
    ...
    Void insertarCliente(@Param("nombre") String nombre, @Param("edad") int edad, @Param("correo") String correo, @Param("telefono") int telefono, @Param("hoteles_id") int hoteles_id);
    ...
    Void actualizarCliente(@Param("id") int id, @Param("nombre") String nombre, @Param("edad") int edad, @Param("correo") String correo, @Param("telefono") int telefono, @Param("hoteles_id") int hoteles_id);
